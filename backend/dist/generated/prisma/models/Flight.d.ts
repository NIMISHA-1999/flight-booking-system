...
export type GetFlightGroupByPayload<T extends FlightGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<FlightGroupByOutputType, T['by']> & {
...
export type FlightWhereInput = {
    ...
    fare?: Prisma.DecimalFilter<"Flight"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
...
export type FlightScalarWhereWithAggregatesInput = {
    ...
    fare?: Prisma.DecimalWithAggregatesFilter<"Flight"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
...
export type FlightOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "flightNumber" | "airline" | "origin" | "destination" | "departureAt" | "arrivalAt" | "fare" | "totalSeats" | "availableSeats" | "createdAt" | "updatedAt", ExtArgs["result"]["flight"]>;
...
export interface FlightFieldRefs {
    ...
    readonly fare: Prisma.FieldRef<"Flight", 'Decimal'>;
