...
export type GetPassengerAggregateType<T extends PassengerAggregateArgs> = {
    [P in keyof T & keyof AggregatePassenger]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregatePassenger[P]> : Prisma.GetScalarType<T[P], AggregatePassenger[P]>;
};
...
export type GetPassengerGroupByPayload<T extends PassengerGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<PassengerGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof PassengerGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], PassengerGroupByOutputType[P]> : Prisma.GetScalarType<T[P], PassengerGroupByOutputType[P]>;
}>>;
export type PassengerWhereInput = {
    ...
    passportNumber?: Prisma.StringFilter<"Passenger"> | string;
    email?: Prisma.StringFilter<"Passenger"> | string;
    contactNumber?: Prisma.StringFilter<"Passenger"> | string;
...
export type PassengerScalarWhereWithAggregatesInput = {
    ...
    passportNumber?: Prisma.StringWithAggregatesFilter<"Passenger"> | string;
    email?: Prisma.StringWithAggregatesFilter<"Passenger"> | string;
    contactNumber?: Prisma.StringWithAggregatesFilter<"Passenger"> | string;
...
export type PassengerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "bookingId" | "fullName" | "dateOfBirth" | "nationality" | "passportNumber" | "email" | "contactNumber" | "createdAt", ExtArgs["result"]["passenger"]>;
...
export type PassengerCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<PassengerFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PassengerDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends PassengerCountArgs>(args?: Prisma.Subset<T, PassengerCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], PassengerCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends PassengerGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, PassengerGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPassengerGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface PassengerFieldRefs {
    ...
    readonly contactNumber: Prisma.FieldRef<"Passenger", 'String'>;
