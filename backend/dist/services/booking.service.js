...
class BookingService {
    ...
    async cancelBooking(bookingId, userId) {
         ...
         * flight departure
         */
        const departureAt = new Date(booking.flight.departureAt);
        ...
        if (booking.status === "PENDING") {
            ...
            console.log(`✅ ${passengerCount} SEAT(S) RELEASED`);
            console.log("========================================");
            return {
        ...
        if (booking.status === "CONFIRMED") {
             ...
             */
            const paymentIntentId = booking.payment
                .stripePaymentIntentId;
            if (!paymentIntentId) {
                throw new Error("Stripe payment information not found.");
            }
            ...
            return {
                ...
                message: "Booking cancelled and payment refund initiated.",
            };
        }
        /*
         * PAYMENT FAILED
        ...
        throw new Error(`Booking cannot be cancelled from ${booking.status} status.`);
    }
}
