...
exports.deleteFlight = exports.updateFlight = exports.createFlight = exports.getFlights = exports.getDashboardStats = exports.cancelBooking = exports.getAllBookings = void 0;
...
const getAllBookings = async (req, res) => {
    try {
         ...
         * =====================================================
         */
        const total = await database_1.prisma.booking.count({
            where,
        });
        /*
         * =====================================================
...
const cancelBooking = async (req, res) => {
    ...
    try {
         ...
         * =====================================================
         */
        const successfulPayment = booking.payment &&
        ...
        if (successfulPayment) {
            try {
                ...
                return res.status(502).json({
                    success: false,
                    message: "Stripe refund could not be processed. Booking was not cancelled and seats were not released.",
...
const getDashboardStats = async (req, res) => {
    try {
         ...
         * =================================================
         */
        const [bookingsToday, totalBookings, pendingBookings, confirmedBookings, cancelledBookings, paymentRevenue,] = await Promise.all([
            /*
             * BOOKINGS TODAY
             */
...
const getFlights = async (req, res) => {
    try {
         ...
         * =================================================
         */
        const total = await database_1.prisma.flight.count({
            where,
        });
        /*
         * =================================================
...
const createFlight = async (req, res) => {
    try {
        const { airline, flightNumber, origin, destination, departureAt, arrivalAt, fare, totalSeats, } = req.body;
        /*
         * =================================================
         * REQUIRED FIELDS
         * =================================================
         ...
         * =================================================
         */
        const flight = await database_1.prisma.flight.create({
            data: {
...
const updateFlight = async (req, res) => {
    try {
         ...
         * =================================================
         */
        const existingFlight = await database_1.prisma.flight.findUnique({
            where: {
                id: flightId,
            },
        });
         ...
         * =================================================
         */
        const bookedSeats = Math.max(0, Number(existingFlight.totalSeats) - Number(existingFlight.availableSeats));
        /*
         * =================================================
         ...
         * =================================================
         */
        const flight = await database_1.prisma.flight.update({
            where: {
                id: flightId,
            },
            data: {
...
const deleteFlight = async (req, res) => {
    try {
         ...
         * =================================================
         */
        await database_1.prisma.flight.delete({
            where: {
                id: flightId,
            },
        });
