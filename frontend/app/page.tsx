...
export default function RegisterPage() {
  return (
    <main className="min-h-screen relative overflow-hidden bg-gradient-to-br from-sky-950 via-blue-900 to-cyan-700">
      ...
      <nav className="relative z-20 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <Link
          href="/login"
          className="rounded-xl border border-white/30 bg-white/10 px-6 py-2 text-white backdrop-blur-lg transition hover:bg-white hover:text-slate-900"
        >
          Login
        </Link>
      ...
      <section className="relative z-10 flex min-h-[calc(100vh-90px)] items-center justify-center px-6">
        ...
        <div className="grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          ...
          <div className="hidden lg:block text-white">
            ...
            <span className="rounded-full bg-cyan-400/20 px-5 py-2 text-sm backdrop-blur-lg">
              Trusted by 15M+ Travelers
            </span>
            ...
            <p className="mt-6 max-w-lg text-lg text-slate-200 leading-8">
              Create your SkyBook account to unlock exclusive fares,
              real-time flight tracking, instant booking confirmation,
          ...
          <div className="rounded-[35px] border border-white/20 bg-white/10 p-2 backdrop-blur-2xl shadow-[0_25px_80px_rgba(0,0,0,.25)]">
